...
[rvpacker-txt-rs](https://github.com/RPG-Maker-Translation-Tools/rvpacker-txt-rs) позволяет генерировать `.json` версии файлов старых движков и записывать их обратно после изменений, а файлы новых движков - уже формата `.json`. Таким образом, ваш перевод будет куда чище.
